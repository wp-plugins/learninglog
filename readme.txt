...
Learninglog is tested up to WordPress 3.0.3 with multisite enabled and BuddyPress 1.2.6 installed.

= There are at least three different installation scenarios: =
...
1. Configer your FTP client to connect to the server hosting your website
...
1. Move the unziped directory from your desktop to the wp-content/plugins directory pointed by the FTP client
